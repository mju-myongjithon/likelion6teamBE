...
class OpenApiDocumentationTests {
	...
	void openApiDocumentsEveryImplementedEndpointAndSessionAuthentication() throws Exception {
		mvc.perform(get("/v3/api-docs"))
				...
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].get.security").doesNotExist())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].get.parameters[1].name")
						.value("page"))
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].get.parameters[1].schema.default")
						.value(0))
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].get.parameters[1].schema.minimum")
						.value(0))
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].get.parameters[2].name")
						.value("size"))
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].get.parameters[2].schema.default")
						.value(5))
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].get.parameters[2].schema.minimum")
						.value(1))
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].get.parameters[2].schema.maximum")
						.value(100))
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries'].post.security[0].sessionCookie")
						.isArray())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries/{inquiryId}'].delete.security[0].sessionCookie")
						.isArray())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/inquiries/{inquiryId}/answer'].post.security[0].sessionCookie")
						.isArray())
				.andExpect(jsonPath("$.components.schemas.GroupInquiryContentRequest.required")
						.value(hasItems("content")))
				.andExpect(jsonPath("$.components.schemas.GroupInquiryContentRequest.properties.content.maxLength")
						.value(1000))
				.andExpect(jsonPath("$.components.schemas.GroupInquiryResponse.properties.canDelete.type")
						.value("boolean"))
				.andExpect(jsonPath("$.components.schemas.GroupInquiryResponse.properties.canAnswer.type")
						.value("boolean"))
				.andExpect(jsonPath("$.paths['/api/chat/rooms'].get.security[0].sessionCookie").isArray())
				.andExpect(jsonPath("$.paths['/api/chat/rooms'].get.responses['200'].content['*/*'].schema.items['$ref']")
						.value("#/components/schemas/ChatRoomSummaryResponse"))
				.andExpect(jsonPath("$.paths['/api/chat/groups/{groupId}/messages'].get.security[0].sessionCookie")
						.isArray())
				.andExpect(jsonPath("$.paths['/api/chat/groups/{groupId}/messages'].get.responses['200'].content['*/*'].schema['$ref']")
						.value("#/components/schemas/ChatHistoryResponse"))
				.andExpect(jsonPath("$.paths['/api/chat/groups/{groupId}/read'].post.security[0].sessionCookie")
						.isArray())
				.andExpect(jsonPath("$.paths['/api/chat/groups/{groupId}/read'].post.responses['204']").exists())
				.andExpect(jsonPath("$.components.schemas.ChatRoomSummaryResponse.properties.groupId.type")
						.value("integer"))
				.andExpect(jsonPath("$.components.schemas.ChatMessageResponse.properties.messageId.type")
						.value("integer"))
				.andExpect(jsonPath("$.components.schemas.MarkReadRequest.required", hasItems("messageId")))
