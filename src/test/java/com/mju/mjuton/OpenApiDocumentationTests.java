...
class OpenApiDocumentationTests {
	...
	void openApiDocumentsEveryImplementedEndpointAndSessionAuthentication() throws Exception {
		mvc.perform(get("/v3/api-docs"))
				...
				.andExpect(jsonPath("$.paths['/api/cafes/recommendations'].post.security[0].sessionCookie").isArray())
				.andExpect(jsonPath("$.paths['/api/cafes/recommendations'].post.responses['200']").exists())
				.andExpect(jsonPath("$.paths['/api/cafes/recommendations'].post.responses['400']").exists())
				.andExpect(jsonPath("$.paths['/api/cafes/recommendations'].post.responses['401']").exists())
				.andExpect(jsonPath("$.paths['/api/cafes/recommendations'].post.responses['403']").exists())
				.andExpect(jsonPath("$.paths['/api/cafes/recommendations'].post.responses['404']").exists())
				.andExpect(jsonPath("$.paths['/api/cafes/recommendations'].post.responses['503']").exists())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/cafes/recommendations'].post.security[0].sessionCookie")
						.isArray())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/cafes/recommendations'].post.responses['200']")
						.exists())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/cafes/recommendations'].post.responses['400']")
						.exists())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/cafes/recommendations'].post.responses['401']")
						.exists())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/cafes/recommendations'].post.responses['403']")
						.exists())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/cafes/recommendations'].post.responses['404']")
						.exists())
				.andExpect(jsonPath("$.paths['/api/groups/{groupId}/cafes/recommendations'].post.responses['503']")
						.exists())
				.andExpect(jsonPath("$.components.schemas.CafeDetail.properties.parkingAvailable.description")
						.value("주차 가능 여부. 카카오 Local 검색만 사용한 경우 확인되지 않아 null입니다."))
				...
				.andExpect(jsonPath("$.components.schemas.ProfileUpdateRequest.properties.residenceLatitude").exists())
				.andExpect(jsonPath("$.components.schemas.ProfileUpdateRequest.properties.residenceLongitude").exists())
